...
public class HarvestWithVeilCriterion extends SimpleCriterionTrigger<HarvestWithVeilCriterion.Conditions> {
    ...
    public record Conditions(Optional<ContextAwarePredicate> playerPredicate) implements SimpleCriterionTrigger.SimpleInstance {
        public static Codec<HarvestWithVeilCriterion.Conditions> CODEC = ContextAwarePredicate.CODEC.optionalFieldOf("player")
