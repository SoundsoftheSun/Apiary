...
public class UseHiveToolCriterion extends SimpleCriterionTrigger<UseHiveToolCriterion.Conditions> {
    ...
    public record Conditions(Optional<ContextAwarePredicate> playerPredicate) implements SimpleCriterionTrigger.SimpleInstance {
        public static Codec<UseHiveToolCriterion.Conditions> CODEC = ContextAwarePredicate.CODEC.optionalFieldOf("player")
