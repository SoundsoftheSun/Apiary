...
public class HoneyBucketClutchCriterion extends SimpleCriterionTrigger<HoneyBucketClutchCriterion.Conditions> {
    ...
    public record Conditions(Optional<ContextAwarePredicate> playerPredicate) implements SimpleCriterionTrigger.SimpleInstance {
        public static Codec<HoneyBucketClutchCriterion.Conditions> CODEC = ContextAwarePredicate.CODEC.optionalFieldOf("player")
