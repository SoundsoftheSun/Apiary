...
public class BKAAdvancements extends FabricAdvancementProvider {
    public BKAAdvancements(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registryLookup) {
    ...
    public void generateAdvancement(HolderLookup.@NonNull Provider provider, @NonNull Consumer<AdvancementHolder> consumer) {
        AdvancementHolder beginning = Advancement.Builder.advancement()
                ...
                .save(consumer, BKA.MOD_ID + ":get_bee_items");
        ...
        AdvancementHolder workerBee = Advancement.Builder.advancement()
                ...
                .save(consumer, BKA.MOD_ID + ":use_hive_tool");

        AdvancementHolder veil = Advancement.Builder.advancement()
                .parent(mutualism)
                .display(
                        ModItems.VEIL,
        ...
        AdvancementHolder extractor = Advancement.Builder.advancement()
                ...
                .save(consumer, BKA.MOD_ID + ":use_extractor");
        ...
        AdvancementHolder clutch = Advancement.Builder.advancement()
                ...
                .save(consumer, BKA.MOD_ID + ":honey_clutch");
