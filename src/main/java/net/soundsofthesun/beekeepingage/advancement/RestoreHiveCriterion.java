...
public class RestoreHiveCriterion extends SimpleCriterionTrigger<RestoreHiveCriterion.Conditions> {
    ...
    public record Conditions(Optional<ContextAwarePredicate> playerPredicate) implements SimpleCriterionTrigger.SimpleInstance {
        public static Codec<RestoreHiveCriterion.Conditions> CODEC = ContextAwarePredicate.CODEC.optionalFieldOf("player")
